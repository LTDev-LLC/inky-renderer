...
// Return the epoch time at the *next* boundary of 'intervalStr' from the
// current local day. E.g., if interval=90 minutes, the boundaries each day are
// 00:00, 01:30, 03:00, 04:30, ... If the parsed duration is invalid, we fall
// back to once‐an‐hour “top of the hour.”
...
WakeEntry calculateNextWake(time_t currentEpoch, const String &sleepStartStr,
                            const String &sleepStopStr, const JsonObject &wakes,
